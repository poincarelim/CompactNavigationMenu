//
// File generated by HDevelop for HALCON/.NET (C#) Version 18.11.2.0
...
public partial class HDevelopExport
{
  ...
  //  action(null,null);
  //}
    public HDevelopExport(Rectangle rect, HWindow hWindow)//HWindowControlWPF hWindowControlWPF)//john
    {
        // Default settings used in HDevelop
        HOperatorSet.SetSystem("width", 512);
        HOperatorSet.SetSystem("height", 512);
    ...
    public static void DoEvents()//john
    {
      ...
      HTuple hv_Title, HTuple hv_Label, HTuple hv_Information, out HTuple hv_PoseOut)
  {
    ...
    private void action(Rectangle rect, HWindow hWindow)//HWindowControlWPF  hv_WindowControl)
  {
    ...
    HTuple hv_iModelNumber = new HTuple(), hv_SAMPLE_DISTANCE = new HTuple();
    HTuple hv_REL_SAMPLE_DISTANCE = new HTuple(), hv_MAX_DISTANCE = new HTuple();
    HTuple hv_ObjectModel3D = new HTuple(), hv_Status = new HTuple();
    HTuple hv_Instructions = new HTuple(), hv_ObjectModel3D_CUT = new HTuple();
    HTuple hv_ObjectModel3DConnected = new HTuple(), hv_ObjectModel3DSelected = new HTuple();
    HTuple hv_Selected_Obj = new HTuple(), hv_Pose = new HTuple();
    HTuple hv_Length1 = new HTuple(), hv_Length2 = new HTuple();
    HTuple hv_Length3 = new HTuple(), hv_CamParam = new HTuple();
    HTuple hv_HomMat3DIdentity = new HTuple(), hv_HomMat3DTranslate = new HTuple();
    HTuple hv_HomMat3DRotate1 = new HTuple(), hv_HomMat3DRotate = new HTuple();
    HTuple hv_FinalObject3D = new HTuple(), hv_ObjectModel3DThresholded1 = new HTuple();
    HTuple hv_Pose2 = new HTuple(), hv_Length11 = new HTuple();
    HTuple hv_Length21 = new HTuple(), hv_Length31 = new HTuple();
    HTuple hv_ObjectModel3D2 = new HTuple(), hv_SampledObjectModel3D_model = new HTuple();
    HTuple hv_SmoothObject3D = new HTuple(), hv_TriangulatedObjectModel3D = new HTuple();
    HTuple hv_Information = new HTuple(), hv_SurfaceModelID = new HTuple();
    HTuple hv_Surface_model = new HTuple(), hv_SurfaceModel_ID = new HTuple();
    HTuple hv_i = new HTuple(), hv_ObjectModel3D1 = new HTuple();
    HTuple hv_Status1 = new HTuple(), hv_ObjectModel3D_ObjCUT = new HTuple();
    HTuple hv_SampledObjectModel3D_find = new HTuple(), hv_SmoothObject3D_find = new HTuple();
    HTuple hv_TriangulatedObjectModel3D1_find = new HTuple();
    HTuple hv_Information1 = new HTuple(), hv_Pose1 = new HTuple();
    HTuple hv_Score = new HTuple(), hv_SurfaceMatchingResultID = new HTuple();
    HTuple hv_ObjectModel3DRigidTrans = new HTuple(), hv_ParamName = new HTuple();
    HTuple hv_ParamValue = new HTuple(), hv_PoseIn = new HTuple();
    HTuple hv_PoseOut = new HTuple(), hv_Exception = new HTuple();
    // Initialize local and output iconic variables 
    try
    {
      dev_update_off();
      ...
      HOperatorSet.OpenWindow(0,0, rect.Width, rect.Height, hWindow, "","",out hv_WindowHandle);
      HDevWindowStack.Push(hv_WindowHandle);

        //list_files ('ply_robostar_200414', 'files', Files)

            //1: Rotor 2: Ring 3: Cylinder 4: Phoxi-m
            hv_iModelNumber.Dispose();
      hv_iModelNumber = 1;
      hv_SAMPLE_DISTANCE.Dispose();
      hv_SAMPLE_DISTANCE = 0.2;
      hv_REL_SAMPLE_DISTANCE.Dispose();
      hv_REL_SAMPLE_DISTANCE = 0.2;
      hv_MAX_DISTANCE.Dispose();
      hv_MAX_DISTANCE = 1;

      if ((int)(new HTuple(hv_iModelNumber.TupleEqual(1))) != 0)
      {
        hv_Files.Dispose();
        HOperatorSet.ListFiles("smaple1_Topview", "files", out hv_Files);
      }
      else if ((int)(new HTuple(hv_iModelNumber.TupleEqual(2))) != 0)
      {
        hv_Files.Dispose();
        HOperatorSet.ListFiles("sample2", "files", out hv_Files);
      }
      else if ((int)(new HTuple(hv_iModelNumber.TupleEqual(3))) != 0)
      {
        hv_Files.Dispose();
        HOperatorSet.ListFiles("ply_robostar_200414", "files", out hv_Files);
      }
      else if ((int)(new HTuple(hv_iModelNumber.TupleEqual(4))) != 0)
      {
        hv_Files.Dispose();
        HOperatorSet.ListFiles("phoxi_sample", "files", out hv_Files);
      }
      else if ((int)(new HTuple(hv_iModelNumber.TupleEqual(5))) != 0)
      {
        hv_Files.Dispose();
        HOperatorSet.ListFiles("RealSenseD435", "files", out hv_Files);
      }
      ...
      HOperatorSet.ReadObjectModel3d(hv_Files.TupleSelect(0), "m", new HTuple(), 
          new HTuple(), out hv_ObjectModel3D, out hv_Status);
      }
      //
      ...
      else if ((int)(new HTuple(hv_iModelNumber.TupleEqual(3))) != 0)
      {
        hv_ObjectModel3D_CUT.Dispose();
        HOperatorSet.SelectPointsObjectModel3d(hv_ObjectModel3D, "point_coord_z", 
            -1100, -1055, out hv_ObjectModel3D_CUT);
      }
      else if ((int)(new HTuple(hv_iModelNumber.TupleEqual(4))) != 0)
      {
        hv_ObjectModel3D_CUT.Dispose();
        HOperatorSet.SelectPointsObjectModel3d(hv_ObjectModel3D, "point_coord_z", 
            690, 740, out hv_ObjectModel3D_CUT);
      }

      hv_ObjectModel3DConnected.Dispose();
      HOperatorSet.ConnectionObjectModel3d(hv_ObjectModel3D_CUT, "distance_3d", hv_MAX_DISTANCE, 
      ...
      if ((int)(new HTuple(hv_iModelNumber.TupleEqual(1))) != 0)
      {
        ...
        HOperatorSet.SelectObjectModel3d(hv_ObjectModel3DConnected, "num_points", 
            "and", 8000, 10000, out hv_ObjectModel3DSelected);
      }
      else if ((int)(new HTuple(hv_iModelNumber.TupleEqual(2))) != 0)
      {
        hv_ObjectModel3DSelected.Dispose();
        HOperatorSet.SelectObjectModel3d(hv_ObjectModel3DConnected, "num_points", 
            "and", 3000, 4000, out hv_ObjectModel3DSelected);
      }
      else if ((int)(new HTuple(hv_iModelNumber.TupleEqual(3))) != 0)
      {
        hv_ObjectModel3DSelected.Dispose();
        HOperatorSet.SelectObjectModel3d(hv_ObjectModel3DConnected, "num_points", 
            "and", 8000, 20000, out hv_ObjectModel3DSelected);
      }
      else if ((int)(new HTuple(hv_iModelNumber.TupleEqual(4))) != 0)
      {
        hv_ObjectModel3DSelected.Dispose();
      ...
      hv_Selected_Obj.Dispose();
      using (HDevDisposeHelper dh = new HDevDisposeHelper())
      {
      hv_Selected_Obj = hv_ObjectModel3DSelected.TupleSelect(
          0);
      }

      hv_Pose.Dispose();hv_Length1.Dispose();hv_Length2.Dispose();hv_Length3.Dispose();
      HOperatorSet.SmallestBoundingBoxObjectModel3d(hv_Selected_Obj, "oriented", 
          out hv_Pose, out hv_Length1, out hv_Length2, out hv_Length3);

      //
      hv_CamParam.Dispose();
      gen_cam_par_area_scan_division(0.01, 0.0, 0.00001, 0.00001, 320, 240, 640, 
          480, out hv_CamParam);
      hv_HomMat3DIdentity.Dispose();
      HOperatorSet.HomMat3dIdentity(out hv_HomMat3DIdentity);
      using (HDevDisposeHelper dh = new HDevDisposeHelper())
      {
      hv_HomMat3DTranslate.Dispose();
      HOperatorSet.HomMat3dTranslate(hv_HomMat3DIdentity, -(hv_Pose.TupleSelect(0)), 
          -(hv_Pose.TupleSelect(1)), -(hv_Pose.TupleSelect(2)), out hv_HomMat3DTranslate);
      }

      if ((int)(new HTuple(hv_iModelNumber.TupleNotEqual(4))) != 0)
      {
        using (HDevDisposeHelper dh = new HDevDisposeHelper())
        {
        hv_HomMat3DRotate1.Dispose();
        HOperatorSet.HomMat3dRotate(hv_HomMat3DTranslate, (new HTuple(180)).TupleRad()
            , "x", 0, 0, 0, out hv_HomMat3DRotate1);
        }
        using (HDevDisposeHelper dh = new HDevDisposeHelper())
        {
        hv_HomMat3DRotate.Dispose();
        HOperatorSet.HomMat3dRotate(hv_HomMat3DRotate1, (new HTuple(-5)).TupleRad()
            , "y", 0, 0, 0, out hv_HomMat3DRotate);
        }
      }
      else
      {
        ...
        {
        hv_HomMat3DRotate1.Dispose();
        HOperatorSet.HomMat3dRotate(hv_HomMat3DTranslate, (new HTuple(0)).TupleRad()
            , "x", 0, 0, 0, out hv_HomMat3DRotate1);
        }
        using (HDevDisposeHelper dh = new HDevDisposeHelper())
        {
        hv_HomMat3DRotate.Dispose();
        HOperatorSet.HomMat3dRotate(hv_HomMat3DRotate1, (new HTuple(0)).TupleRad()
            , "y", 0, 0, 0, out hv_HomMat3DRotate);
        }

      }

      hv_FinalObject3D.Dispose();
      HOperatorSet.AffineTransObjectModel3d(hv_Selected_Obj, hv_HomMat3DRotate, out hv_FinalObject3D);
      //
      hv_Pose.Dispose();
      visualize_object_model_3d(hv_WindowHandle, hv_FinalObject3D, hv_CamParam, new HTuple(), 
          (new HTuple("color")).TupleConcat("disp_pose"), (new HTuple("green")).TupleConcat(
          "true"), "A 3D object model", "", hv_Instructions, out hv_Pose);
      //

      //Set ROI
      //select_points_object_model_3d (ObjectModel3D, 'point_coord_z', -1, 10, ObjectModel3DThresholded1)
      hv_ObjectModel3DThresholded1.Dispose();
      HOperatorSet.SelectPointsObjectModel3d(hv_FinalObject3D, "point_coord_z", -1, 
          1, out hv_ObjectModel3DThresholded1);

      hv_Pose2.Dispose();hv_Length11.Dispose();hv_Length21.Dispose();hv_Length31.Dispose();
      HOperatorSet.SmallestBoundingBoxObjectModel3d(hv_FinalObject3D, "oriented", 
          out hv_Pose2, out hv_Length11, out hv_Length21, out hv_Length31);
      hv_ObjectModel3D2.Dispose();
      HOperatorSet.GenBoxObjectModel3d(hv_Pose2, hv_Length11, hv_Length21, hv_Length31, 
          out hv_ObjectModel3D2);
      //visualize_object_model_3d (WindowHandle, [FinalObject3D,ObjectModel3D2], CamParam, Pose, ['color_0','color_1','alpha_1','disp_pose'], ['green','yellow',0.5,'true'], 'Axis-aligned bounding boxes', '', Instructions, Pose)


      //hom_mat3d_identity (HomMat3DIdentity1)
      //hom_mat3d_translate (HomMat3DIdentity1, -Pose2[0], -Pose2[1], -Pose2[2], HomMat3DTranslate1)
      //hom_mat3d_rotate (HomMat3DTranslate1, rad(Pose2[5]), 'z', 0, 0, 0, HomMat3DRotate1)
      //hom_mat3d_rotate (HomMat3DRotate1, rad(Pose2[4]), 'y', 0, 0, 0, HomMat3DRotate2)
      //hom_mat3d_rotate (HomMat3DRotate2, rad(Pose2[3]), 'x', 0, 0, 0, HomMat3DTemp)
      //affine_trans_object_model_3d (ObjectModel3DThresholded1, HomMat3DTemp, ObjectModel3DAffineTrans)

      //hom_mat3d_invert (HomMat3DTemp, HomMat3DOrigin)
      //affine_trans_object_model_3d (ObjectModel3DAffineTrans, HomMat3DOrigin, ObjectModel3DAffineTrans1)

      //xyz_to_object_model_3d
      //object_model_3d_to_xyz(

      hv_SampledObjectModel3D_model.Dispose();
      HOperatorSet.SampleObjectModel3d(hv_FinalObject3D, "fast", hv_SAMPLE_DISTANCE, 
          new HTuple(), new HTuple(), out hv_SampledObjectModel3D_model);
      hv_SmoothObject3D.Dispose();
      HOperatorSet.SmoothObjectModel3d(hv_SampledObjectModel3D_model, "mls", "mls_force_inwards", 
          "true", out hv_SmoothObject3D);

      hv_TriangulatedObjectModel3D.Dispose();hv_Information.Dispose();
      HOperatorSet.TriangulateObjectModel3d(hv_SmoothObject3D, "greedy", new HTuple(), 
          new HTuple(), out hv_TriangulatedObjectModel3D, out hv_Information);
      //create_surface_model (TriangulatedObjectModel3D, REL_SAMPLE_DISTANCE, 'train_3d_edges', 'true', SurfaceModelID)
      hv_SurfaceModelID.Dispose();
      HOperatorSet.CreateSurfaceModel(hv_TriangulatedObjectModel3D, hv_REL_SAMPLE_DISTANCE, 
          new HTuple(), new HTuple(), out hv_SurfaceModelID);
      hv_Surface_model.Dispose();
      HOperatorSet.GetSurfaceModelParam(hv_SurfaceModelID, "sampled_model", out hv_Surface_model);

      HOperatorSet.WriteSurfaceModel(hv_SurfaceModelID, "SurfaceModel.sfm");
      //write_tuple (HomMat3DTemp, 'HomMat3dTemp.tup')
      //write_tuple (HomMat3DOrigin, 'HomMat3DOrigin.tup')
      HOperatorSet.WriteObjectModel3d(hv_FinalObject3D, "ply", "FinalObject3D", new HTuple(), 
          new HTuple());
      HOperatorSet.WriteObjectModel3d(hv_TriangulatedObjectModel3D, "ply", "TriangulatedObjectModel3D", 
          new HTuple(), new HTuple());

      using (HDevDisposeHelper dh = new HDevDisposeHelper())
      {
      HTuple ExpTmpOutVar_0;
      visualize_object_model_3d(hv_WindowHandle, hv_TriangulatedObjectModel3D.TupleConcat(
          hv_ObjectModel3D2), hv_CamParam, hv_Pose, (((new HTuple("color_0")).TupleConcat(
          "color_1")).TupleConcat("alpha_1")).TupleConcat("disp_pose"), (((new HTuple("green")).TupleConcat(
          "yellow")).TupleConcat(0.5)).TupleConcat("true"), "Axis-aligned bounding boxes", 
      ...
      hv_SurfaceModel_ID.Dispose();
      HOperatorSet.ReadSurfaceModel("SurfaceModel.sfm", out hv_SurfaceModel_ID);
      hv_ObjectModel3D.Dispose();hv_Status.Dispose();
      HOperatorSet.ReadObjectModel3d("FinalObject3D.ply", "m", new HTuple(), new HTuple(), 
      ...
      for (hv_i=0; (int)hv_i<=(int)((new HTuple(hv_Files.TupleLength()))-1); hv_i = (int)hv_i + 1)
      {
        ...
        using (HDevDisposeHelper dh = new HDevDisposeHelper())
        {
        hv_ObjectModel3D1.Dispose();hv_Status1.Dispose();
        HOperatorSet.ReadObjectModel3d(hv_Files.TupleSelect(hv_i), "m", new HTuple(), 
            new HTuple(), out hv_ObjectModel3D1, out hv_Status1);
        }

        if ((int)(new HTuple(hv_iModelNumber.TupleEqual(1))) != 0)
        {
          hv_ObjectModel3D_ObjCUT.Dispose();
          HOperatorSet.SelectPointsObjectModel3d(hv_ObjectModel3D1, "point_coord_z", 
              -1050, -950, out hv_ObjectModel3D_ObjCUT);
        }
        else if ((int)(new HTuple(hv_iModelNumber.TupleEqual(2))) != 0)
        {
          hv_ObjectModel3D_ObjCUT.Dispose();
        ...
        else if ((int)(new HTuple(hv_iModelNumber.TupleEqual(3))) != 0)
        {
          hv_ObjectModel3D_ObjCUT.Dispose();
          HOperatorSet.SelectPointsObjectModel3d(hv_ObjectModel3D1, "point_coord_z", 
              -1100, -1055, out hv_ObjectModel3D_ObjCUT);
        }
        else if ((int)(new HTuple(hv_iModelNumber.TupleEqual(4))) != 0)
        {
          hv_ObjectModel3D_ObjCUT.Dispose();
          HOperatorSet.SelectPointsObjectModel3d(hv_ObjectModel3D1, "point_coord_z", 
              690, 740, out hv_ObjectModel3D_ObjCUT);
        }

        //* 매칭 정확도와 속도 조절을 위한 샘플링과 triangulation 파라미터 설정
        hv_SampledObjectModel3D_find.Dispose();
        HOperatorSet.SampleObjectModel3d(hv_ObjectModel3D_ObjCUT, "fast", hv_SAMPLE_DISTANCE, 
            new HTuple(), new HTuple(), out hv_SampledObjectModel3D_find);
        hv_SmoothObject3D_find.Dispose();
        HOperatorSet.SmoothObjectModel3d(hv_SampledObjectModel3D_find, "mls", "mls_force_inwards", 
            "true", out hv_SmoothObject3D_find);
        hv_TriangulatedObjectModel3D1_find.Dispose();hv_Information1.Dispose();
        HOperatorSet.TriangulateObjectModel3d(hv_SmoothObject3D_find, "greedy", new HTuple(), 
            new HTuple(), out hv_TriangulatedObjectModel3D1_find, out hv_Information1);

        try
        {
          hv_Pose1.Dispose();hv_Score.Dispose();hv_SurfaceMatchingResultID.Dispose();
          HOperatorSet.FindSurfaceModel(hv_SurfaceModel_ID, hv_TriangulatedObjectModel3D1_find, 
              hv_REL_SAMPLE_DISTANCE, 0.9, 0.6, "false", "num_matches", 50, out hv_Pose1, 
              out hv_Score, out hv_SurfaceMatchingResultID);

          hv_ObjectModel3DRigidTrans.Dispose();
          HOperatorSet.RigidTransObjectModel3d(hv_ObjectModel3D, hv_Pose1, out hv_ObjectModel3DRigidTrans);
          hv_ParamName.Dispose();
          hv_ParamName = new HTuple();
          hv_ParamName[0] = "disp_pose";
          hv_ParamName[1] = "color_0";
          hv_ParamName[2] = "color_1";
          hv_ParamName[3] = "alpha_0";
          hv_ParamValue.Dispose();
          hv_ParamValue = new HTuple();
          hv_ParamValue[0] = "true";
          hv_ParamValue[1] = "gray";
          hv_ParamValue[2] = "magenta";
          hv_ParamValue[3] = 0.3;
          hv_PoseIn.Dispose();
          hv_PoseIn = new HTuple();
          hv_PoseIn[0] = 112.538;
          hv_PoseIn[1] = -96.9617;
          hv_PoseIn[2] = 11831.8;
          hv_PoseIn[3] = 161.912;
          ...
          //debug_find_surface_model (SurfaceModel_ID, ObjectModel3D, TriangulatedObjectModel3D1_find, SurfaceMatchingResultID, CreateSurfaceModelParamName, CreateSurfaceModelParamValue, FindSurfaceModelParamName, FindSurfaceModelParamValue)

          using (HDevDisposeHelper dh = new HDevDisposeHelper())
          {
          hv_PoseOut.Dispose();
          visualize_object_model_3d(hv_WindowHandle, hv_TriangulatedObjectModel3D1_find.TupleConcat(
              hv_ObjectModel3DRigidTrans), new HTuple(), hv_PoseIn, hv_ParamName, 
              hv_ParamValue, new HTuple(), new HTuple(), hv_Pose1, out hv_PoseOut);
          }
        }
        // catch (Exception) 
        catch (HalconException HDevExpDefaultException1)
        {
          ...
          using (HDevDisposeHelper dh = new HDevDisposeHelper())
          {
          disp_message(hv_WindowHandle, "Error 발생"+hv_Exception, "window", 12, 
              12, "black", "true");
          }
        }
        //stop ()
    ...
    catch (HalconException HDevExpDefaultException)
    {
      ...
      hv_SampledObjectModel3D_model.Dispose();
      hv_SmoothObject3D.Dispose();
      hv_TriangulatedObjectModel3D.Dispose();
      ...
      hv_SampledObjectModel3D_find.Dispose();
      hv_SmoothObject3D_find.Dispose();
      hv_TriangulatedObjectModel3D1_find.Dispose();
      hv_Information1.Dispose();
      hv_Pose1.Dispose();
      hv_Score.Dispose();
